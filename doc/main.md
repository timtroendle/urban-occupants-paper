...
In the application of this methodology to the London Borough of Haringey, the average thermal energy demand for space heating varies only marginally between the 145 LSOA's of in average around 1700 citizens into which Haringey is divided and to which results are aggregated. The standard deviation of energy demand per dwelling varies much more among the LSOA's indicating a higher diversity of household compositions in these parts of the city.
